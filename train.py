...
if __name__ == '__main__':
    ...
    parser.add_argument('-p','--pre_train',help='wheter or not load pre train model',default='no',type=str)
    parser.add_argument('-pt','--pre_path',type=str)
    ...
    if args.pre_train =='yes':
        print('load pre_trained model ....')            
        learner.load_state(conf,args.pre_path,from_save_folder=False, model_only=False)
